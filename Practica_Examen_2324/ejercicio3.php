...
if (isset($_POST["btnCodificar"])) {
    ...
    $error_archivo = $_FILES["archivo"]["name"] == "" || $_FILES["archivo"]["type"] != "text/plain" || $_FILES["archivo"]["size"] >= 12500 * 1024;
    $errores_formulario = $error_texto || $error_des || $error_archivo;
}
...
<body>
    ...
    <?php
    if (isset($_POST["btnCodificar"]) && !$errores_formulario) {
