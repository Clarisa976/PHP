...
<form action="recogida_datos.php" method="post" enctype="multipart/form-data">
    ...
    <p>
        ...
        <input type="radio" name="sexo" id="Hombre"><label for="sexo">Hombre</label><br>
        <input type="radio" name="sexo" id="Mujer"><label for="sexo">Mujer</label><br>
    </p>
    <p>
    ...
    <textarea name="comenarios" id="comentarios"></textarea>
    </p>
    <p>
