const DIR_API="http://localhost/Proyectos/PHP/Tema5/Ejercicios_SW/Actividad1_2_MA/Actividad1/servicios_rest";
...
function validar_form_editar(cod) {
    ...
    $.ajax({
        ...
        dataType: "json",
        type: "PUT",
        data: { "nombre": nombre, "descripcion": descripcion, "PVP": PVP, "familia": familia }
    })
        .done(function (data) {
            if (data.error) {
                $("#errores").html(data.error);
