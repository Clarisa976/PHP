...
{
     session_destroy();
     die(error_page("Pr","<p>Error consumiendo el servicio Rest: <strong>".$url."</strong></p>"));
}
if(isset($json_respuesta["error"]))
{
     session_destroy();
     die(error_page("Pr","<p>".$json_respuesta["error"]."</p>"));
}
...
$datos_usuario_log=$json_respuesta["usuario"];
